# Project Management — Enterprise Deployment Guide
...
## Docker Deployment
```bash
cd enterprise/etrack/docker
docker-compose up -d
```

## Kubernetes Deployment
```bash
cd enterprise/etrack/helm
helm install eos-etrack . -f values.yaml -n eos-enterprise
```
