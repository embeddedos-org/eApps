package com.eos.eappsuite.core.common.models
...
data class ThemeConfig(
    ...
    val primaryColorHex: String = "#1976D2",
    val accentColorHex: String = "#FF6F00",
...
data class UserPrefs(
    ...
    val disabledAppIds: List<String> = emptyList(),
    val lastOpenedAppId: String? = null
)
package com.eos.eappsuite.core.common.models
