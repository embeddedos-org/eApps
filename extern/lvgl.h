...
static inline void lv_arc_set_bg_angles(lv_obj_t *o, int s, int e) { (void)o;(void)s;(void)e; }
...
static inline lv_layer_t *lv_canvas_get_layer(lv_obj_t *o) { (void)o; return NULL; }
