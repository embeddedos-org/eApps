...
static eplay_ctx_t ctx;
static bool eplay_init(lv_obj_t *parent) {
...
const eapps_app_info_t eplay_info = {
    .id = "eplay", .name = "ePlay", .icon = "ply",
    .description = "Video player", .category = EAPPS_CAT_MEDIA, .version = "2.0.0",
};
