...
static const char*ci(car_t c){switch(c){case C_FEDEX:return LV_SYMBOL_TRASH;case C_UPS:return LV_SYMBOL_HOME;case C_DHL:return LV_SYMBOL_CHARGE;case C_AMZ:return LV_SYMBOL_LIST;   /* LVGL has no cart symbol */default:return LV_SYMBOL_GPS;}}
...
/* A second, unrelated stub implementation was appended below this point -
 * its own #include, etrack_ctx_t, and duplicate etrack_init/deinit/info/
 * lifecycle symbols. The implementation above is complete, so the stub was
