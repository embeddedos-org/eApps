...
PLATFORM_EXT = {
    ...
    'vscode': '.vsix', 'jetbrains': '.jar', 'obsidian': '.zip',
    'sublime': '.sublime-package', 'neovim': '.zip',
    'slack': '.zip', 'raycast': '.zip', 'github': '.zip',
    'google-workspace': '.zip', 'office365': '.zip',
